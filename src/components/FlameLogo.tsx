...
export default function FlameLogo({ size = 32 }: { size?: number }) {
  return (
    ...
    >
      <defs>
        <linearGradient id="flame-outer" x1="32" y1="60" x2="32" y2="4" gradientUnits="userSpaceOnUse">
          <stop offset="0" stopColor="#ef4444" />
          <stop offset="0.55" stopColor="#f97316" />
          <stop offset="1" stopColor="#f59e0b" />
        </linearGradient>
        <linearGradient id="flame-inner" x1="32" y1="58" x2="32" y2="28" gradientUnits="userSpaceOnUse">
